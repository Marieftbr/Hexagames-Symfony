 ...
 */
final class Version20201127145431 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment CHANGE comment_id user_comment_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment CHANGE user_comment_id comment_id INT DEFAULT NULL');
